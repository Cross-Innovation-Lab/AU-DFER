...
class VideoDataset(data.Dataset):
    def __init__(self, list_file, num_segments, duration, mode, transform, image_size):
        ...
        self.AU_file = '/root/FERV39K/AU_FERV39K.txt'
    ...
    def _parse_list(self):
        ...
        for line in AU_list:
            ...
            for x in labels:
                l.append(int(x))
            #print(l)
            #print('/root/FERV39K/2_ClipsforFaceCrop/'+line[:-36])
            self.AU_dict['/root/FERV39K/2_ClipsforFaceCrop/'+line[:-36]] = l
    ...
    def get(self, record, indices):
        ...
        for frame in video_frames_path:
            ...
            if AU_key not in self.AU_dict:
                continue
            frame_count += 1
            for i in range(0,18):
                AU_labels[i]+=self.AU_dict[AU_key][i]
