...
class Options(object):
    ...
    def initialize(self):
        ...
        parser.add_argument('--dataset', type=str, default="FERV39K")
        ...
        parser.add_argument('--root', default='/root/FERV39K', type=str)
    ...
    def parse(self):
        ...
        if args.dataset == "DFEW":
            ...
            args.train_dataset = os.path.join(
                args.root, "4_setups/All_scenes/train_All.csv")
            args.test_dataset = os.path.join(
                args.root, "4_setups/All_scenes/test_All.csv")
